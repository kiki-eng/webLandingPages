      ...
      <div className="px-4 sm:px-6">
        <div className="flex items-center justify-between py-6 lg:justify-start lg:space-x-10">
          ...
          <div className="-my-2 -mr-2 lg:hidden">
            <Popover.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-busines-dark hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-busines-primary">
          ...
          <div className="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
            <div className="px-5 pt-5 pb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <Popover.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-busines-dark hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  {solutions.map((item) => (
                    ...
                    >
                      <item.icon
                        className="flex-shrink-0 w-6 h-6 text-busines-primary"
                        aria-hidden="true"
                      />
            ...
            <div className="px-5 py-6 space-y-6">
              <div>
                <a
                  href={process.env.REACT_APP_MERCHANT_SIGNUP_LOGIN_URL}
                  rel="noopener"
                  className="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white transition-colors duration-150 ease-in-out border border-transparent rounded-md shadow-sm bg-busines-primary hover:bg-busines-dark"
                >
                  Become a merchant
                </a>
                <p className="mt-6 text-base font-medium text-center text-busines-dark">
                  Existing merchant?{" "}
                  <a
                    href={process.env.REACT_APP_MERCHANT_LOGIN_URL}
                    rel="noopener"
                    className="text-busines-primary hover:text-indigo-500"
                  >
                    Sign in
                  </a>
                </p>
